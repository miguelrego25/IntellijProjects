...
public class VideoYoutube {
    ...
    public VideoYoutube(String nome, char[] video, int resol, int min, int sec) {
    ...
    public VideoYoutube(VideoYoutube v) {
        this(v.nomeVideo, v.video, v.resolucao, v.getMinutos(), v.getSegundos());
    }

    public boolean equals(VideoYoutube v) {
